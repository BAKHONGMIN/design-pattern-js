...
/**Assuming
 *^_^을 그리는 renderer를 구현한다.
 */

class Renderer {
    render(data) {
        console.log('prepare something to render.');
        //somthing here..
        this._render(data);
    }
...
class ConsoleRenderer extends Renderer {
    _render(data) {
        console.log(`${data} is rendered using console.`);
    }
}

class CanvasRenderer extends Renderer {
    _render(data) {
        console.log(`${data} is rendered using canvas.`);
    }
}
